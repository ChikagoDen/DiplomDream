...
class CreateCommentTablesTable extends Migration
{
    ...
    public function up()
    {
        DB::unprepared("
            ...
            ) ENGINE=InnoDB AUTO_INCREMENT=94 DEFAULT CHARSET=utf8 COMMENT='коментарии';
            ...
            /*!50003 CREATE*/  /*!50003 TRIGGER `comment_table_AFTER_INSERT` AFTER INSERT ON `comment_table` FOR EACH ROW BEGIN
            ...
            /*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
            /*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
            /*!50003 CREATE*/ /*!50003 TRIGGER `comment_table_AFTER_UPDATE` AFTER UPDATE ON `comment_table` FOR EACH ROW BEGIN
