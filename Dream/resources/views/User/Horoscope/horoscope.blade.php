...
@section('contentMainArticle')
    ...
    <h2 class="h" style="display: inline-flex;     flex-wrap: wrap; align-items: center;"><img style="    width: 100px;" src="{{asset('../resources/img/zodiac_signs/Aquarius.png')}}" alt="Водолей" class="zodiac-signs" > Водолей (21 января – 19 февраля).</h2>
    <p class="text">    
       Гороскоп для водолея (21 января – 19 февраля).
    </p>
    {{-- попробовать передать для гороскопа и использовать слайдер --}}

    <x-Horoscope.Slider-Horoscop :getPuttBooks="$getPuttBooks">
        <x-slot name="h">
            <h2 class="h">Гороскопы</h2>
        </x-slot> 
    </x-Horoscope.Slider-Horoscop>
         Я водолей!
        ...
        <label for="pseudoBtn{{$i=1}}" class="tmp-navig-button">Ответить</label>
        ...
        <div class="coment">
            <form action="" method="get">
                ...
                <label>
                    ...
                    <textarea name="descriptionDream" rows="3" cols="10" value="Гороскоп" style="width: 100%"></textarea>
                </label>
